...
qforce/0.0.9 darwin-x64 node-v10.13.0
$ qforce --help [COMMAND]
USAGE
  $ qforce COMMAND
...
...
_See code: [src/commands/dev/config.ts](https://github.com/qislam/qforce/blob/v0.0.9/src/commands/dev/config.ts)_
...
_See code: [src/commands/dev/migrate.ts](https://github.com/qislam/qforce/blob/v0.0.9/src/commands/dev/migrate.ts)_
...
_See code: [src/commands/dx/exe.ts](https://github.com/qislam/qforce/blob/v0.0.9/src/commands/dx/exe.ts)_
...
_See code: [src/commands/dx/ol.ts](https://github.com/qislam/qforce/blob/v0.0.9/src/commands/dx/ol.ts)_
...
_See code: [src/commands/dx/open.ts](https://github.com/qislam/qforce/blob/v0.0.9/src/commands/dx/open.ts)_
...
_See code: [src/commands/dx/query.ts](https://github.com/qislam/qforce/blob/v0.0.9/src/commands/dx/query.ts)_
