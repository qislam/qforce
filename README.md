...
qforce/0.4.5 darwin-x64 node-v10.13.0
$ qforce --help [COMMAND]
USAGE
  $ qforce COMMAND
...
...
* [`qforce dev:deploy [FEATUREBRANCH] [DEVELOPBRANCH]`](#qforce-devdeploy-featurebranch-developbranch)
...
_See code: [src/commands/dev/config.ts](https://github.com/qislam/qforce/blob/v0.4.5/src/commands/dev/config.ts)_

## `qforce dev:deploy [FEATUREBRANCH] [DEVELOPBRANCH]`

Deploy source components included in a feature branch.
...
_See code: [src/commands/dev/deploy.ts](https://github.com/qislam/qforce/blob/v0.4.5/src/commands/dev/deploy.ts)_
...
_See code: [src/commands/dev/migrate.ts](https://github.com/qislam/qforce/blob/v0.4.5/src/commands/dev/migrate.ts)_

## `qforce dev:patch [FEATUREBRANCH] [DEVELOPBRANCH]`

Prepare and apply a patch to current branch from another branch.
...
OPTIONS
  ...
  -s, --syncUp               Set to true if need to retrieve
...
_See code: [src/commands/dev/patch.ts](https://github.com/qislam/qforce/blob/v0.4.5/src/commands/dev/patch.ts)_
...
_See code: [src/commands/dx/describe.ts](https://github.com/qislam/qforce/blob/v0.4.5/src/commands/dx/describe.ts)_
...
_See code: [src/commands/dx/exe.ts](https://github.com/qislam/qforce/blob/v0.4.5/src/commands/dx/exe.ts)_
...
_See code: [src/commands/dx/ol.ts](https://github.com/qislam/qforce/blob/v0.4.5/src/commands/dx/ol.ts)_
...
_See code: [src/commands/dx/open.ts](https://github.com/qislam/qforce/blob/v0.4.5/src/commands/dx/open.ts)_
...
_See code: [src/commands/dx/query.ts](https://github.com/qislam/qforce/blob/v0.4.5/src/commands/dx/query.ts)_
